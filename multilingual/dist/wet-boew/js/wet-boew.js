...
class Dropdown {
	constructor( dropdown ) {
		...
		this.buttonNode = dropdown.querySelector( ":scope > button" );
		this.menuNode = dropdown.querySelector( ":scope > ul" );
		this.menuitemNodes = [];
		this.firstMenuitem = false;
		this.lastMenuitem = false;
		this.firstChars = [];

		this.menuNode.classList.add( "dropdown-menu" );
		this.buttonNode.classList.add( "dropdown-toggle" );
		...
		// Add caret icon to dropdown button
		if ( !this.buttonNode.querySelector( ".dropdown-toggle-icon" ) ) {
			let caretElm = document.createElement( "span" );

			caretElm.classList.add( "glyphicon" );
			caretElm.classList.add( "glyphicon-chevron-down" );
			caretElm.classList.add( "dropdown-toggle-icon" );
			this.buttonNode.append( caretElm );
		}
